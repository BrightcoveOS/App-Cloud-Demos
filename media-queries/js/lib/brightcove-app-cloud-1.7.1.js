...
( function( $ ) {
  ...
  * @param errorCallback The function that is called if this is not supported, if there is an error, or if the user cancels out of the process.
  The <code>errorCallback</code> function is passed an object that contains a property named <code>errorCode</code>, which maps to one of the codes defined in <code>bc.device.codes</code>, and a property named <code>errorMessage</code>, which provides
    additional information about this error.
 ...
 /**
  * Specify which directions the application can be rotated to.  The directions should be passed in as an array and can take in five different values:
  * <ul>
  ...
  */
  ...
  /**
   * <p>Brings up a native QR scanner to read 2D QR codes.  On success, this will call the <code>successCallback</code>, passing to the function the string that is represented by
   * reflects the scanned QR code.</p>
   *
